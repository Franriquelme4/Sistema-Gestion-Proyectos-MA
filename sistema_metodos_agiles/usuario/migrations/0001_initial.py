# Generated by Django 4.1 on 2022-11-25 05:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('historial', models.ManyToManyField(to='usuario.historial')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comentario', models.ManyToManyField(blank=True, to='usuario.comentario')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('proyecto', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='usuario.proyecto')),
                ('sprint', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='usuario.sprint')),
                ('us', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='usuario.userstory')),
                ('usuario', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='usuario.usuario')),
            ],
            options={
                'verbose_name': 'hora_trabajadas',
                'verbose_name_plural': 'horas_trabajada',
                'ordering': ['fecha_creacion'],
            },
        ),
        migrations.AddField(
